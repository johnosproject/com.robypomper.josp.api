...
package com.robypomper.josp.jcp.defs.frontend.pub;
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP Front End";
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/pub/frontend";
