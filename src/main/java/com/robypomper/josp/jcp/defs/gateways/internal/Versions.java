...
package com.robypomper.josp.jcp.defs.gateways.internal;
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP Gateways (Internal)";
    public static final String API_SERVICE = "JCP Gateways";
    // API SubGroups
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/jcp/gateways";
