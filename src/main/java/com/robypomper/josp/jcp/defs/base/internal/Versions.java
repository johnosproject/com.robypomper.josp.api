...
package com.robypomper.josp.jcp.defs.base.internal;
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP Base (Internal)";
    public static final String API_SERVICE = "JCP Base";
    // API SubGroups
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/jcp/base";
