...
package com.robypomper.josp.jcp.defs.jslwebbridge.pub.admin;
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP JSL Web Bridge Admin";
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/pub/jslwebbridge/admin";
