...
package com.robypomper.josp.jcp.defs.jslwebbridge.internal;

import com.robypomper.josp.consts.APIVersionsAbs;


/**
 * JCP JSL Web Bridge (Internal)
 * <p>
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP JSL Web Bridge (Internal)";
    public static final String API_SERVICE = "JCP JSL Web Bridge";
    // API SubGroups
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/jcp/jslwebbridge";
