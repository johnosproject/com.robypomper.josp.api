...
package com.robypomper.josp.jcp.defs.jslwebbridge.pub.core;

import com.robypomper.josp.consts.APIVersionsAbs;


/**
 * JCP JSL Web Bridge Core
 * <p>
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP JSL Web Bridge Core";
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/pub/jslwebbridge/core";
