...
package com.robypomper.josp.jcp.defs.apis.internal;
...
public class Versions extends APIVersionsAbs {
    ...
    // API Group
    public static final String API_NAME = "JCP APIs (Internal)";
    ...
    // Urls
    public static final String API_PATH_BASE = "/apis/jcp/apis";
