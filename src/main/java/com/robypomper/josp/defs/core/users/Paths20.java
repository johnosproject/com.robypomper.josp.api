...
public class Paths20 {
    ...
    public final static String DOCS_DESCR = "Get users info";
    ...
    //@formatter:off
    // User methods
    private static final String MTHD_CURRENT        = "current";
    //@formatter:on
    ...
    //@formatter:off
    // User methods
    public static final String FULL_PATH_CURRENT        = API_PATH + "/" + API_VER + "/" + MTHD_CURRENT;
    //@formatter:on
    ...
    //@formatter:off
    // User methods
    public static final String DESCR_PATH_CURRENT       = "Return current user's info";
    //@formatter:on
