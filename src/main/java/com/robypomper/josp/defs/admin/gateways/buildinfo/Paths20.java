...
public class Paths20 extends com.robypomper.josp.jcp.defs.base.internal.status.buildinfo.Paths20 {
    ...
    public final static String DOCS_DESCR = "Methods to query JCP Gateways build info";
    ...
    //@formatter:off
    // List methods
    public static final String DESCR_PATH_JCP_GWS_BUILDINFO_LIST           = "Return JCP Gateways servers list";
    // Build Info methods
    public static final String DESCR_PATH_JCP_GWS_BUILDINFO      = DESCR_PATH_BUILDINFO;
    //@formatter:on
