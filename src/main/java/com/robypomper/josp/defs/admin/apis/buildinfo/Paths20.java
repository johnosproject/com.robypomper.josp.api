...
public class Paths20 extends com.robypomper.josp.jcp.defs.base.internal.status.buildinfo.Paths20 {
    ...
    public final static String DOCS_DESCR = "Methods to query JCP APIs build info";
    ...
    //@formatter:off
    // Build Info methods
    public static final String FULL_PATH_JCP_APIS_BUILDINFO     = API_PATH + "/" + API_VER + "/" + MTHD_BUILDINFO;
    //@formatter:on
    ...
    //@formatter:off
    // Build Info methods
    public static final String DESCR_PATH_JCP_APIS_BUILDINFO      = DESCR_PATH_BUILDINFO;
    //@formatter:on
